...
export default function IssuesPage() {
  ...
  const handleEditorMount: OnMount = (editor, monaco) => {
    ...
    // Listen for changes
    editor.onDidContentSizeChange(resizeEditorToContent);
  };
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="absolute" style={{ top: "21px", left: "769px" }}>
      ...
      <Link href="/" style={{ textDecoration: "none" }}>
        <div
          className="glass-logo-feature absolute flex items-center"
          style={{
            top: "21px",
            left: "1416px",
          }}
      ...
      <div
        className="left-background-rectangle relative flex items-center"
        style={{
          top: "117px",
          left: "13px",
        }}
      ...
      <div
        className="left-inner-rectangle relative flex items-center"
        style={{
          top: "198px",
          left: "13px",
        }}
            ...
            {analysis ? (
              <>
                ...
                <div style={{ marginBottom: "16px" }}>
                  ...
                  {analysis.issue_summary.labels.join(", ") || "None"}
                </div>
                <div style={{ marginBottom: "16px" }}>
                  <strong>Assignees:</strong>{" "}
                  {analysis.issue_summary.assignees.join(", ") || "None"}
                </div>
                <div style={{ marginBottom: "16px" }}>
      ...
      <div
        className="right-background-rectangle relative flex items-center"
        style={{
          top: "117px",
          left: "564px",
        }}
      ...
      <div
        className="right-inner-rectangle relative flex items-center"
        style={{
          top: "200px",
          left: "564px",
          zIndex: 1,
      ...
      >
        ...
        >
          ...
          />
          <path
            d="M0 0 C5.61 0 11.22 0 17 0 C17.33 1.32 17.66 2.64 18 4 C17 5 17 5 13.18359375 5.09765625 C11.60153318 5.09098089 10.01948841 5.07901875 8.4375 5.0625 C7.63119141 5.05798828 6.82488281 5.05347656 5.99414062 5.04882812 C3.99606244 5.03700518 1.99802217 5.01906914 0 5 C0 3.35 0 1.7 0 0 Z "
            fill="#FFFFFF"
            transform="translate(12,20)"
          />
          <path
            d="M0 0 C5.61 0 11.22 0 17 0 C17.33 1.32 17.66 2.64 18 4 C17 5 17 5 13.40234375 5.09765625 C11.91403133 5.0909822 10.42573568 5.07902183 8.9375 5.0625 C8.17888672 5.05798828 7.42027344 5.05347656 6.63867188 5.04882812 C4.75908129 5.0370068 2.87953101 5.01907078 1 5 C0.67 3.35 0.34 1.7 0 0 Z "
            fill="#FFFFFF"
            transform="translate(12,27)"
          />
          <path
            d="M0 0 C1.98 0 3.96 0 6 0 C6.5625 1.9375 6.5625 1.9375 7 4 C6 5 6 5 2.4375 5.0625 C1.303125 5.041875 0.16875 5.02125 -1 5 C-0.67 3.35 -0.34 1.7 0 0 Z "
            fill="#FFFFFF"
      ...
      <nav
        ...
        style={{
          ...
          borderStyle: "solid",
          borderImageSource:
            "conic-gradient(from 90deg at 0% 0%, rgba(255,255,255,0) -47.02deg, rgba(255,255,255,0.4) 42.98deg, rgba(255,255,255,0) 132.98deg, rgba(255,255,255,0.4) 222.98deg, rgba(255,255,255,0) 312.98deg, rgba(255,255,255,0.4) 402.98deg)",
          fontFamily: "Montserrat, sans-serif",
          fontWeight: 400,
          fontSize: "43px",
          lineHeight: "100%",
      ...
      >
        <Editor
          height={"auto"}
          language={getMonacoLanguageFromPath("/src/main.tsx")} //change based on what the file type is
          value={
            selectedFile?.keySections && selectedFile.keySections.length > 0
